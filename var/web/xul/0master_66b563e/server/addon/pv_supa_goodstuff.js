...
addon.pv_supa_goodstuff.prototype = {
    'common_ui_init' : function() {
        ...
        try {
            ...
            mc.setAttribute(
                'src',
                '/xul/0master_66b563e/server/locale/'+LOCALE+'/addon/pv_supa_goodstuff.properties'
            );
            ...
            var uri = ios.newURI(
                'oils://remote/xul/0master_66b563e/server/skin/addon/pv_supa_goodstuff.css',
                null,
                null
            );
    ...
    'prefs_init' : function() {
        ...
        try {
            ...
            var url = '/xul/0master_66b563e/server/addon/pv_supa_goodstuff_config_overlay.xul';

...
function my_init() {
    try {
        ...
        req.open('GET','/xul/0master_66b563e/server/locale/' + locale + '/' + tooltip_doc,true);
...
function loadMarcEditor(pcrud, marcxml, target, sf) {
     ...
     */
    win = window.open('/xul/0master_66b563e/server/cat/marcedit.xul', '_blank', 'chrome'); // XXX version?

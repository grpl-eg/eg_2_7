        function my_init() {
            try {
                ...
                try {
                    g.error.standard_unexpected_error_alert('/xul/0master_66b563e/server/cat/spine_labels.xul',E);
                } catch(F) {
        ...
        function preview(idx) {
            try {
                    ...
                    var html = "<html><head>";
                    html += "<link type='text/css' rel='stylesheet' href='" + xulG.url_prefix('/xul/0master_66b563e/server/skin/print.css') + "'></link>"

...
function link_patron(direction) {
    try {
        ...
        for (var i = 0; i < g.sel_list.length; i++) {    
            ...
            if (direction) {
                xml += '<image src="/xul/0master_66b563e/server/skin/media/images/patron_right_arrow.png"/>';
            } else {
                xml += '<image src="/xul/0master_66b563e/server/skin/media/images/patron_left_arrow.png"/>';
            }
            xml += '</hbox>';
